var user = localStorage.getItem("adminUserName");
    ...
    //   var con_info = [s, p, u, d];
      ...
      $.ajax ({
          ...
          cache: false,            
            success: function(r){ 
            $('#titleHeading').html(r[0].company.toUpperCase() +' / Delivery Tagging v.1.4');
            }
        });
      } 
       ...
       var dialog = bootbox.dialog({
        ...
        var botboxMsg = '';
         $.ajax ({
              url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
              type: "GET",
              data: {"type":"GET_DELIVERY_TAGGING", "startDate":start, "endDate":end, "CONN":con_info},
              dataType: "json",
              crossDomain: true,
              cache: false,  
              async: false,          
      ...
      function datatableApp(){
           tableData = $('#stockRequest_TAB').DataTable({
              ...
              columns: [
                ...
                buttons: [
                //   {
                //       text: '<i class="fa fa-file-archive-o"></i> SALES SUMMARY',
                ...
                //   },
                //   {
                //       text: '<i class="fa fa-file-archive-o"></i> UNPRODUCTIVE',
                //       // className: 'bringtoprint',
                //       action: function(e, dt, node, config){
