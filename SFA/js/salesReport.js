       ...
       var dialog = bootbox.dialog({
        ...
        var botboxMsg = '';
         $.ajax ({
              url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
              type: "GET",
              data: {"type":"salesReport", "startDate":start, "endDate":end, "CONN":con_info},
              dataType: "json",
              crossDomain: true,
              cache: false,  
              async: true,          
      ...
      function datatableApp(){
           tableData = $('#stockRequest_TAB').DataTable({
              ...
              columns: [
                  ...
                  { data: "Notation" },
                  { data: "Sales" },
                  { data: "transactionTypeChecker" },
                  { data: "isHitSR" },
                  { data: "isHitGEO" },
                  { data: "OverrideTransaction" },
                  { data: "CustomerChannel" }
                ],
                buttons: [
                  {
                      extend: 'collection',
                      text: '<i class="fa fa-file-archive-o"></i> Other Reports',
                      autoClose: true,
                      buttons: [
                          {
                              text: 'Sales Summary',
                          ...
                          },
                          {
                            text: 'Range Summary',
                              // className: 'bringtoprint',
                              action: function(e, dt, node, config){
                                window.open('https://mybuddy-sfa.com/SFA/rangeSummary', '_blank');
                              }   
                          },
                          {
                              ...
                              // className: 'bringtoprint',
                              action: function(e, dt, node, config){
                                window.open('https://mybuddy-sfa.com/SFA/rangeMonitoring', '_blank');
                              }   
                          },
                          {
                            text: 'Geocall Rate',
                            // className: 'bringtoprint',
                              action: function(e, dt, node, config){
                                window.open('https://mybuddy-sfa.com/SFA/geocallrate', '_blank');
                              }   
                          },
                          {
                              text: 'Strike Rate',
                              // className: 'bringtoprint',
                              action: function(e, dt, node, config){
                                window.open('https://mybuddy-sfa.com/SFA/strikerate', '_blank');
                              }   
                          },
                           {
                              ...
                              // className: 'bringtoprint',
                              action: function(e, dt, node, config){
                                window.open('https://mybuddy-sfa.com/SFA/skusalesdetails', '_blank');
                              }   
                          },
                          {
                              text: 'Unproductive',
                              // className: 'bringtoprint',
                              action: function(e, dt, node, config){
                                window.open('https://mybuddy-sfa.com/SFA/unproductiveReport', '_blank');
                              }   
                          },
                          {
                              ...
                              // className: 'bringtoprint',
                              action: function(e, dt, node, config){
                                window.open('https://mybuddy-sfa.com/SFA/fastsosyotransaction', '_blank');
                              }   
                          },
                          {
                              ...
                              // className: 'bringtoprint',
                              action: function(e, dt, node, config){
                                window.open('https://mybuddy-sfa.com/SFA/voucherHistory', '_blank');
                              }   
                          },
                      ]
                  },
            ...
            $( api.column( 13 ).footer() ).html(
                'Total Sales: ₱ '+pageTotal.toLocaleString() +' ('+ total.toLocaleString() +')'
            );
          }
        });
