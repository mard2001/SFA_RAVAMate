...
function ercsoloadSalesman(){
    $.ajax ({
        url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
        type: "GET",
        data: {"type":"ERIC_SO_SALESMANLIST", "CONN":con_info},
        dataType: "json",
        crossDomain: true,
        cache: false,          
        async: false,  
...
function getProductList(){
    $.ajax ({
        url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
        type: "GET",
        data: {"type":"GET_ALL_PRODUCT_BTDT", "CONN":con_info},
        dataType: "json",
        crossDomain: true,
        cache: false,          
        async: false,  
...
function executSyncSweeperTransaction(){
    ...
    if(r){
        ...
        $.ajax ({
            url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
            type: "GET",
            data: {"type":"SYNC_SWEEPER_TRANSACTION", "CONN":con_info}, 
            dataType: 'json',     
            crossDomain: true,
            cache: false,   
            success: function(response){   
...
function invSync(){
    ...
    if(r){
        ...
        $.ajax ({
            url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
            type: "GET",
            data: {"type":"SyncInventory", "mdCode":mdCode,"CONN":con_info , "site":user}, 
            dataType: 'json',     
            crossDomain: true,
            cache: false,   
            success: function(response){   
...
function custSync(){
    ...
    $.ajax ({
        url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
        type: "GET",
        data: {"type":"SyncCustomer", "CONN":con_info}, 
        dataType: 'json',     
        crossDomain: true,
        cache: false,   
        success: function(response){   
...
function custSync2(){
    ...
    if(r){
        ...
        $.ajax ({
            url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
            type: "GET",
            data: {"type":"SyncCustomer2", "CONN":con_info}, 
            dataType: 'json',     
            crossDomain: true,
            cache: false,   
            success: function(response){   
    ...
    if(dssdate == null || dssdate == '' || dssdate == undefined){
        ...
        if(r){
            ...
            $.ajax ({
                url: GLOBALLINKAPI+"/nestle/connectionString/POST_applicationAPI.php",
                type: "POST",
                data: {"type":"SYNC_IDELIVER_INVOICE", "CONN":con_info , "site":GLBLCIDHOLDER, 'dateselected':dssdate}, 
                dataType: 'json',     
                crossDomain: true,
                cache: false,   
                success: function(response){   
...
function executeQueingSync(){
    ...
    if(r){
        ...
        $.ajax ({
            url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
            type: "GET",
            data: {"type":"SYNC_SFA_QUEUING", "CONN":con_info}, 
            dataType: 'json',     
            crossDomain: true,
            cache: false,   
            success: function(response){   
...
function execDatareplication(){
    ...
    if(r){
        ...
        $.ajax ({
            url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
            type: "GET",
            data: {"type":"SYNC_DATA_REPLACATION", "mdCode":mdCode,"CONN":con_info}, 
            dataType: 'json',     
            crossDomain: true,
            cache: false,   
            success: function(response){   
...
function goSyncDelTagging(){
    ...
    if(r){
        ...
        $.ajax ({
            url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
            type: "GET",
            data: {"type":"SYNC_IDELIVER_DELIVERY_TAGGING", "CONN":con_info , "site":GLBLCIDHOLDER}, 
            dataType: 'json',     
            crossDomain: true,
            cache: false,   
            success: function(response){   
...
function loadBTDTDrivers(){
    $.ajax ({
        url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
        type: "GET",
        data: {"type":"get_all_btdt_Drivers", "CONN":con_info},
        dataType: "json",
        crossDomain: true,
        cache: false,          
        async: false,  
...
function loadActiveBTDTDrivers(){
    $.ajax ({
        url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
        type: "GET",
        data: {"type":"get_all_active_btdt_Drivers", "CONN":con_info},
        dataType: "json",
        crossDomain: true,
        cache: false,          
        async: false,  
...
function getercpendingrec(){
        ...
        url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
        type: "GET",
        data: {"type":"GET_ERC_PENDING_REC", "CONN":con_info},
        dataType: "json",
        crossDomain: true,
        cache: false,          
        async: false,  
...
function exec_get_pending_erc_so(){
        ...
        $.ajax ({
            url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
            type: "GET",
            data: {"type":"GET_PENDING_ERC_SO", "CONN":con_info}, 
            dataType: 'json',     
            crossDomain: true,
            cache: false,  
            async: false, 
...
function exec_get_pending_erc_payments(){
        ...
        $.ajax ({
            url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
            type: "GET",
            data: {"type":"GET_PENDING_ERC_PAYMENTS", "CONN":con_info}, 
            dataType: 'json',     
            crossDomain: true,
            cache: false,  
            async: false, 
...
function exec_get_pending_returns(){
        ...
        $.ajax ({
            url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
            type: "GET",
            data: {"type":"GET_PENDING_ERC_RETURNS", "CONN":con_info}, 
            dataType: 'json',     
            crossDomain: true,
            cache: false,  
            async: false, 
...
function datatableApp(){
    tableData = $('#stockRequest_TAB').DataTable({
        ...
        rowCallback: function(row, data, index){
            ...
            //     }
            //     $(row).find('td:eq(13)').text('â‚±' + Number(parseFloat(salesFormat).toFixed(2)).toLocaleString());
            //     // READY
...
function stockRequestSourceData(){
    $.ajax ({
        url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
        type: "GET",
        data: {"type":"GET_SO_PER_TRANSACTION", "CONN":con_info },
        dataType: "json",
        crossDomain: true,
        cache: false,  
        async: true,          
...
function sendtoeric_per_transaction(datatosync){
    ...
    $.ajax ({
        url: GLOBALLINKAPI+"/nestle/connectionString/applicationipAPI.php",
        type: "GET",
        data: {"type":"EXEC_SYNC_TO_ERIC_SO_PER_TRANSACTION", "CONN":con_info, "datatosync":localdata},
        dataType: "json",
        crossDomain: true,
        cache: false,  
        async: true,          
