              ...
              if(data.length == 0){
                ...
                for(var x=0; x<data.length; x++){
                  ...
                  // src='data:image/jpeg;base64,"+data[x].thumbnail+"' --not base64 img/erw.jpg
                   var contentString = "<div style='margin: 0 auto;'><div class='modal-header' style='text-align: center;'>"+
                        "<div class=''><img class='salesmanPic' alt='salesmanPic' style='border: solid 3px "+data[x].mdColor+"' src='/upload/salesman-image/"+data[x].mdCode+".jpg' onError='imgError(this)'/>"+
                         "<br/><span class='label label-pill label-danger count' style='font-size: 10px; border-radius:100%; float:center; background-color:"+data[x].mdColor+";' id='getThisTransCount'>"+data[x].transCount+"</span>"+
                         "<span class='fa fa-chevron-left pull-left' style='float: left; font-size: 30px;' onclick='prevInfo()' id='prevMD'></span><span id='nextMD' onclick='nextInfo()' class='fa fa fa-chevron-right pull-right' style='float: left; font-size: 30px;'></span></div></div>"+
                            "<div class='table-responsive'>" +
                               "<table class='table table-condensed'>" +
...
(function($) {
 ...
 function showTopSeller(){
    Swal.fire({
        // icon: 'info',
        // title: `<h2><i class="fas fa-medal" style="color: gold;"></i> Top Seller</h2>`,
        html: `
            <div style="float: left;">
                <i class="fas fa-chevron-left" style="color: #333; font-size: 15px;"></i> PREV
            </div>
            <div style="float: right;">
                NEXT <i class="fas fa-chevron-right" style="color: #333; font-size: 15px;"></i> 
            </div>
                <div style="float: center; margin: 0 auto; width: 100%;">
                    <h2><i class="fas fa-medal" style="color: gold;"></i> Top Seller</h2>
                    <div>
                        <div style="float: left;">
                        <img style="margin-right: 40px !important; width: 100px; height: 100px; border-radius: 100px;" src="/img/jhun.png">
                        </div>
                        <div>
                            <div style="margin-left: 30px !important; margin-top: 50px;">
                                <p style="font-size: 30px; text-align:left;">JHUN WOOGIE ARRABIS</p>
                                <p style="font-size: 20px; text-align:left;">Total Sales: &#8369 1,032,322</p>
                                <p style="font-size: 20px; text-align:left;">Total Accounts: 13</p>
                            </div>
                        </div>
                    </div>
                </div>`,
