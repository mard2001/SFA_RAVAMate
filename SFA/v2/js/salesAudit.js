...
// getcompname();
getcompname_dynamic("Sales Audit", "titleHeading");
function getcompname(){
    $.ajax ({
        ...
        cache: false,            
        success: function(r){ 
            $('#titleHeading').html(r[0].company.toUpperCase() +' | Sales Audit');
        }
    });
} 
...
function stockRequestSourceData(start, end) {
    ...
    $.ajax({
        url: GLOBALLINKAPI + "/connectionString/applicationipAPI.php",
        type: "POST",
        data: { "type": "GET_MOR_SALESAUDIT", "start": start, "end": end, "userID": GBL_USERID, "distCode": GBL_DISTCODE},
        dataType: "json",
        crossDomain: true,
        cache: false,
        success: function (r) {
...
function datatableApp(){
    ...
    tableData = $('#stockRequest_TAB').DataTable({
        ...
        columns: [
            { data: "Salesperson", title: "Salesman" },
            { data: "custCode", title: "Custcode" },
            { data: "custName", title: "Customer" },
            { data: "refno", title: "Ref No."},
            { data: "sentDate", title: "Sent Date" },
            { data: "deliveryDate", title: "Delivery Date" },
            { data: "totalAmount", title: "Total Amount" },
            { data: "longitude", title: "Longitude" },
            { data: "latitude", title: "Latitude" },
            { data: "versionNo", title: "Version No." },
            { data: "batteryStat", title: "Battery Status" },
            { data: "upTime", title: "Uptime" },
            { data: "transactionTypeChecker", title: "Source"},
            { data: "SOReference", title: "Document No."}
        ],
