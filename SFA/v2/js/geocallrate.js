...
getcompname_dynamic("Geocall Rate v.1.0", "titleHeading");
// getcompname();
function getcompname(){
    $.ajax ({
        ...
        success: function(r){ 
            ...
            $('#titleHeading').html(r[0].company.toUpperCase() +' | Geocall Rate v.1.0');
        }
    });
} 
...
function stockRequestSourceData(start){
    ...
    $.ajax ({
        url: GLOBALLINKAPI+"/connectionString/applicationipAPI.php",
        type: "POST",
        data: {"type":"GET_GEOCALL_RATE", "date_selected":start, "userID": GBL_USERID, "distCode": GBL_DISTCODE},
        dataType: "json",
        crossDomain: true,
        cache: false,  
        async: false,          
...
function datatableApp(){
    tableData = $('#stockRequest_TAB').DataTable({
        ...
        columns: [
            ...
            { data: "MCP", title: "MCP" },
            { data: "GeoCallRate", title: "GeoCallRate" },
