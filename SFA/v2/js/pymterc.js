...
// getcompname();
getcompname_dynamic("Payment to ERIC logs", "titleHeading");
...
function getcompname(){
    $.ajax ({
        ...
        cache: false,            
        success: function(r){ 
            $('#titleHeading').html(r[0].company.toUpperCase() +' | Payment to ERIC logs');
        }
    });
} 
...
function stockRequestSourceData(start, end){
    ...
    $.ajax ({
        ...
        type: "GET",
        data: {
            type: "GET_ERIC_PAYMENTS_SENDING_LOGS",
            CONN: con_info,
            startdate: start,
            enddate: end,
        },  
    ...
    tableData = $('#stockRequest_TAB').DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                text: 'Excel',
                title: '',
                filename: 'PAYMENTS - '+ moment().format("DD-MMM-YYYY"),
