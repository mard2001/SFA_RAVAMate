...
getcompname_dynamic("Delivery Monitoring Report", "titleHeading");
// getcompname();
function getcompname(){
    $.ajax ({
        ...
        cache: false,            
        success: function(r){ 
            $('#titleHeading').html(r[0].company.toUpperCase() +' | Delivery Monitoring Report');
        }
    });
}
...
function stockRequestSourceData(start, end){
    ...
    $.ajax ({
        url: GLOBALLINKAPI+"/connectionString/applicationipAPI.php",
        type: "POST",
        data: {"type":"GET_DELIVERY_MONITORING", "start":start, "end":end, "userID": GBL_USERID, "distCode": GBL_DISTCODE},
        dataType: "json",
        crossDomain: true,
        cache: false,  
        async: false,          
...
function datatableApp(){
    tableData = $('#stockRequest_TAB').DataTable({
        ...
        columns: [
            ...
            { data: "STOREID", title: "CUSTCODE" },
            { data: "STORENAME", title: "CUSTOMERo." },
            { data: "refno", title: "REFNO" },
            { data: "TRANSACTIONDATE", title: "TRANSACTION DATE" },
            { data: "formatted_amount", title: "TOTAL AMOUNT" },
            { data: "DISPATCHDATE", title: "DISPATCH DATE" },
            { data: "DELIVERYDATE", title: "DELIVERY DATE" },
            { data: "duration", title: "DURATION" },
            { data: "TURN_ARROUND_TIME", title: "TURN AROUND TIME" },
        ],
