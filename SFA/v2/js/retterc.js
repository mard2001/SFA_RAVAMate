...
// getcompname();
getcompname_dynamic("Returns to ERIC logs", "titleHeading");
...
function getcompname(){
    $.ajax ({
        ...
        cache: false,            
        success: function(r){ 
            $('#titleHeading').html(r[0].company.toUpperCase() +' | Returns to ERIC logs');
        }
    });
} 
...
function stockRequestSourceData(start, end){
    ...
    $.ajax ({
        ...
        type: "GET",
        data: {
            type: "GET_ERIC_RETURNS_SENDING_LOGS",
            CONN: con_info,
            startdate: start,
            enddate: end,
        },  
    ...
    tableData = $('#stockRequest_TAB').DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                text: 'Excel',
                title: '',
                filename: 'RETSALESLOGSTOERC - '+ moment().format("DD-MMM-YYYY"),
