...
// getcompname();
getcompname_dynamic("Offsite Transaction", "titleHeading");
...
function getcompname(){
    $.ajax ({
        ...
        cache: false,            
        success: function(r){ 
            $('#titleHeading').html(r[0].company.toUpperCase() +' | Offsite Transaction');
        }
    });
} 
...
function datatableApp(){
    tableData = $('#stockRequest_TAB').DataTable({
        ...
        columns: [
            ...
            { data: "geolocation", title:"Geo Location" },
        ...
        buttons: [
            ...
            },
            {
                ...
                text: 'Excel',
                title: '',
                filename: 'OffSiteTransactions - '+ moment().format("DD-MMM-YYYY"),
